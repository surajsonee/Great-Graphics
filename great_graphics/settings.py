"""
Django settings for great_graphics project.
...
ALLOWED_HOSTS = ['great-graphics.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'great_graphics.urls'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'great-graphics'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'greatgraphics@example.com'
else:
